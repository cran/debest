#' @title A derived biomarker dataset from a trial of usrodeoxycholic acid
#'
#' @description dat_udca is derived from the udca data from the R survival package with biomarker variables defined as the baseline bilirubin level > 1.
#' @source udca data from the R survival package.
#'   \url{https://CRAN.R-project.org/package=survival}
#'
#' @format A data frame with 169 rows and 12 variables:
#' \describe{
#'  \item{id}{subject id}
